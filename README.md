...
Имеется веб приложение bingo, о котором мало что известно, но точно известно: 
1. Где его испоняемый файл
2. Относительные адреса ручек для api
3. Приложение должно быть отказоучтойчивым, держать заданную нагрузку втечение заданного времени и быть развёрнутым до 01.12.23
...
Внимание: dockerfile содержит спойлеры!
